...
public: 
	Pitanje(int id, const char* tekst, const char* oblast, double bodovi) : _id(id), _bodovi(bodovi) {
...
public: 
 ...
 //pitanja na ispisu).  //Napomena: Podatke o odgovorima cuvati u zasebnoj memoriji i istu dealocirati unutar same klase. 
...
//esejski dio pitanja, dok se karakteristike tog pojma postavljaju kroz MCMA tip pitanja.
 ...
 //Dodati ostale potrebne funkcije za rad sa klasom. 
	...
	class Test {
		...
		Pitanje* _pitanja[30]; // test studenta sadrži najviše 30 pitanja razlicitog tipa 
