...
EsejskoPitanje::EsejskoPitanje(const char* tacanOdg) : _tacanOdgovor(AlocirajNizKaraktera(tacanOdg)) {
}

EsejskoPitanje::EsejskoPitanje(const EsejskoPitanje& ep) : _tacanOdgovor(AlocirajNizKaraktera(ep._tacanOdgovor)),
_odgovorStudenta(AlocirajNizKaraktera(ep._odgovorStudenta)) {
	_tekst = AlocirajNizKaraktera(ep._tekst);
	_oblast = AlocirajNizKaraktera(ep._oblast);
	_id = ep._id;
	_bodovi = ep._bodovi;
}
