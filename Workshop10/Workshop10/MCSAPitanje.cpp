...
MCSAPitanje::MCSAPitanje(const MCSAPitanje& x) : MCMAPitanje(*const_cast<MCSAPitanje*>(&x)) {
}
MCSAPitanje::~MCSAPitanje() {}
...
MCSAPitanje& MCSAPitanje::operator=(MCSAPitanje& mp) {
	MCMAPitanje::operator=(mp);
